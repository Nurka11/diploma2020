...
{% block sidebar %}
  <div id="content-related">
    <div class="module" id="recent-actions-module">
      <h4 class="italic-title">Мои действия:</h4>
        ...
        <ul class="actionlist">
          {% for entry in admin_log %}
            <li class="{% if entry.is_addition %}addlink{% endif %}{% if entry.is_change %}changelink{% endif %}{% if entry.is_deletion %}text-error{% endif %}">
              ...
              {% spaceless %}
                {% if entry.is_addition %}{% trans 'Добавлен'|capfirst %}{% endif %}
                {% if entry.is_change %}{% trans 'Изменен'|capfirst %}{% endif %}
                {% if entry.is_deletion %}{% trans 'Удален'|capfirst %}{% endif %}
