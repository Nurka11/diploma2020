{% load static %}{% load admin_static %}{% load suit_tags %}{% load url from suit_compat %}<!DOCTYPE html>
...
<head>
  ...
  <link rel="shortcut icon" type="image/png" href="{% static 'mon_app/images/favicon.ico' %}">
  {% endif %}
          ...
          <div id="header" class="header">
            <div id="branding">
              <a href="{% url 'admin:index' %}">
                <h1 id="site-name"><img src="{% static "mon_app/images/favicon.ico" %}"/>
            ...
            <div class="header-content">
                ...
                <div class="header-column">
                    <a href="/" class="grey">simplemonitoring.com</a><br>
                    <span class="grey">Повышаем эффективность вашего бизнеса</span>
                </div>
            </div>
            {% endblock %}
            ...
            {% if user.is_active and user.is_staff %}
              <div id="user-tools">
                ...
                {% block userlinks %}
                  ...
                  {% endif %}
                  <a href="{% url 'index_url' %}">Открыть сайт</a>
                  <span class="separator">|</span>
...
{% block footer %}
  ...
  <div id="footer" class="footer">
    <div class="content">
      ...
      <div class="copyright">
        {% block copyright %}
          Copyright &copy; {% now "Y" %} Price Monitoring<br>Developed by <a href="http://vk.com/4heck" target="_blank">Mamleev Ruslan</a>
        {% endblock %}
      </div>
