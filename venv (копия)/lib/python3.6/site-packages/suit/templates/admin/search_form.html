  ...
  <div id="toolbar" class="clearfix">
    <form id="changelist-search" action="" method="get" class="form-inline">
      <div class="search-container">
        {% if cl.search_fields %}
          <input type="text" size="40" name="{{ search_var }}" value="{{ cl.query }}" id="searchbar" placeholder="{% block search_placeholder %}{% trans 'Введите название продукта'|capfirst %}{% endblock %}"{{ cl.query|yesno:' class=active,' }}>&nbsp;
