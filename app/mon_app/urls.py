...
from .views import index, parsing, support, line_chart, line_chart_json, get_with_prefix
...
urlpatterns = [
    ...
    path('graphic', line_chart, name='line_chart'),
    path('get_prefix', get_with_prefix, name='get_with_prefix')
]
